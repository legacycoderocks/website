...
export function PlayButton({ player, size = 'large' }) {
  return (
    <button
      type="button"
      className={clsx(
        'group relative flex flex-shrink-0 items-center justify-center rounded-full bg-brand-red-500 hover:bg-brand-red-700 focus:outline-none focus:ring-slate-700',
        {
